...
im_clus7(im_clus7 ~= 7) = 0; im_clus7 = sign(im_clus7);

% ////////////////////////////////////////////////////////////////////////
% Displaying section
%/////////////////////////////////////////////////////////////////////////

figure('Name','Segnmented Image no.of Cluster = 7');
subplot(1,7,1);
...
subplot(1,7,7);
imshow(repmat(im_clus7,[1,1,3]).*I_rgb); 
title('Cluster7');
xlabel(cen_Color(7));
%}