function [ outIMG,low_edges ] = le_image2( inputIMG_shpA )
%LE_IMAGE Summary of this function goes here
%   Low_edges Extraction (thickness = 2, side trimmed)
...
for i =  1:ncols
    if (low_edges2(i) > 1 )
        ...
        if( low_edges2(i) < size(inputIMG_shpA,1))
            outIMG(low_edges2(i)+1,i) = 1;
            outIMG(low_edges2(i)-1,i) = 1;
        end
    end
end
