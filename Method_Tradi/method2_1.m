% ------------------------------------------------------------------------
% Method2 : K-means Color & Gabor Positive Bank on Low Edges Max Vote
% ------------------------------------------------------------------------

function [I_le_segmented_mode, t0] = method2_1(IMG_NO,IMG_DIR)    
...
I_kresult(nRows, nCols, NO_CLUS) = zeros;   % each kmeans Result
...
for k = 1:2%NO_CLUS                         % can replace by 2 for speed up
